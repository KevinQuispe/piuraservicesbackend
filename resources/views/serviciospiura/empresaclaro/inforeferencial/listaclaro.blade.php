...
<div class="breadcrumb-holder">
  ...
  <div class="row"> 
    ...
    <div class="card miBorder fadeIn animated">
      ...
      <a href="{{url('/serviciospiura/empresaclaro/listar/create')}}" class="btn btn-success btn-sm margenInf fadeIn animated ion-plus-round"> Nuevo</a> &nbsp;
          ...
          <tr class="bg-primary">
              ...
              <th>Acciones</th>
                ...
                <tr class="fadeIn animated">
                  ...
                  <td><a href="http://www.claro.com.pe/" target="_blank" title="Open Web">{{$empresa->webentidad}}</td></a>
