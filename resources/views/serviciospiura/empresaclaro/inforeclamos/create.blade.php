          ...
          <div class="card miBorder">
            ...
            <br>
              <div class="form-group">
                ...
                {!!form::textarea('descripcion', null,['id'=>'descripcion','class'=>'form-control offset col-sm-12 col-md-6 col-lg-5','placeholder'=>'Ingrese descripción'])!!}
              </div>
              <br>
              ...
              <div class="form-group">
                ...
                <a href="{{url('/serviciospiura/empresaclaro/reclamos')}}"
