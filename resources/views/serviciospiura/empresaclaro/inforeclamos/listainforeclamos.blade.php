...
<div class="breadcrumb-holder">
  ...
  <div class="row"> 
    ...
    <div class="card miBorder fadeIn animated">
      ...
      <a href="{{url('/serviciospiura/empresaclaro/reclamos/create')}}" class="btn btn-success btn-sm margenInf fadeIn animated ion-plus-round"> Nuevo</a> &nbsp;
              ...
              <th>Acciones</th>
                ...
                <tr class="fadeIn animated">
                  ...
                  <td class="text-center">
                    <a href="{{action('Admininfo\infoclaro\ReclamosController@edit', $reclamos->id)}}" class="btn btn-outline-primary btn-sm ion-edit" title="Editar">Editar</a>
                    <a href="{{action('Admininfo\infoclaro\ReclamosController@show', $reclamos->id)}}" class="btn btn-outline-danger btn-sm ion-android-delete" title="Eliminar">Eliminar</a>
                  </td>
                </tr>
              @endforeach
                </tbody>
