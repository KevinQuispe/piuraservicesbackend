        ...
        <div class="offset-lg-2 col-lg-7">
          <div class="card miBorder">
            ...
            <div class="card-block">
              {!!Form::model($contactos, ['action'=>['Admininfo\infoclaro\ContactosController@update',$contactos->id],'method'=>'PUT'])!!}
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              {!!form::submit('Guardar',['name'=>'grabar','id'=>'grabar','content'=>'<span class="glyphicon glyphicon-floppy-disk">Guardar</span>',
                ...
                <a href="{{url('/serviciospiura/empresaclaro/contactos')}}" class="btn btn-primary ion-android-cancel btn-sm"> Cancelar</a>
              </div>
              {!!Form::close()!!}
            </div>        
          </div>
