        ...
        <div class="offset-lg-2 col-lg-7">
          <div class="card miBorder">
            ...
            <div class="card-block">
              {!!Form::model($tramites, ['action'=>['Admininfo\infoclaro\TramitesController@update',$tramites->id],'method'=>'PUT'])!!}
            ...
            <div class="form-group">
                ...
                {!!form::text('nombre', null,['id'=>'nombre','class'=>'form-control','placeholder'=>'Ingrese nombre de trámite'])!!}
              </div>
              <div class="form-group">
                <label class="form-control-label" for="telefono"><strong>Descripcion:</strong></label>
                {!!form::textarea('descripcion',null,['id'=>'descripcion','class'=>'form-control','placeholder'=>'Ingrese descripcion de trámite'])!!}
              </div>
              ...
              {!!form::submit('Guardar',['name'=>'grabar','id'=>'grabar','content'=>'<span class="glyphicon glyphicon-floppy-disk">Guardar</span>',
                ...
                <a href="{{url('/serviciospiura/empresaclaro/tramites')}}" class="btn btn-primary ion-android-cancel btn-sm"> Cancelar</a>
              </div>
