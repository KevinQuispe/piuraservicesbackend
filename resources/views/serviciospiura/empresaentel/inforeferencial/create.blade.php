        ...
        <div class="offset col-md">
          <div class="card miBorder">
            ...
            <div class="form-group">
                ...
                {!!form::text('telefono', null,['id'=>'telefono','class'=>'form-control offset  offset col-sm-12 col-md-6 col-lg-5','placeholder'=>'Ingrese número de telefónico'])!!}
            </div>
            <br>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <a href="{{url('/serviciospiura/empresaentel/listar')}}"
