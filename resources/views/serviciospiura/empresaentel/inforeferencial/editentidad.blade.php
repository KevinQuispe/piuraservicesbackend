...
<div class="breadcrumb-holder">
    <div class="container-fluid">
      <ul class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{url('/serviciospiura/empresaentel/listar')}}">Entidades</a></li>
        ...
        <div class="offset-lg-2 col-lg-7">
          <div class="card miBorder">
            ...
            <div class="card-block">
              {!!Form::model($entidad, ['action'=>['Admininfo\infoentel\EntelController@update',$entidad->id],'method'=>'PUT'])!!}
