        ...
        <div class="offset-lg-2 col-lg-7">
          <div class="card miBorder">
            ...
            <div class="card-block">
              {!!Form::model($reclamos, ['action'=>['Admininfo\infoentel\ReclamosController@update',$reclamos->id],'method'=>'PUT'])!!}
            ...
            <div class="form-group">
                ...
                {!!form::text('nombre', null,['id'=>'Nombre reclamo','class'=>'form-control','placeholder'=>'Ingrese nombre de reclamo'])!!}
              </div>
              <div class="form-group">
                <label class="form-control-label" for="telefono"><strong>Descripcion:</strong></label>
                {!!form::textarea('descripcion',null,['id'=>'descripcion','class'=>'form-control','placeholder'=>'Ingrese dscripción de reclamo'])!!}
              </div>
              ...
              {!!form::submit('Guardar',['name'=>'grabar','id'=>'grabar','content'=>'<span class="glyphicon glyphicon-floppy-disk">Guardar</span>',
                ...
                <a href="{{url('/serviciospiura/empresaentel/reclamos')}}" class="btn btn-primary ion-android-cancel btn-sm"> Cancelar</a>
              </div>
              {!!Form::close()!!}
            </div>        
          </div>
