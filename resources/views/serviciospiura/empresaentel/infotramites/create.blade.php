        ...
        <div class="offset col-md">
          <div class="card miBorder">
            ...
            <div class="form-group">
                ...
                {!!form::textarea('descripcion', null,['id'=>'descripcion','class'=>'form-control offset  offset col-sm-12 col-md-6 col-lg-5','placeholder'=>'Ingrese descripcion de trámite'])!!}
            </div>
            <br>
            ...
            <div class="pull-right">
              <div class="form-group">
                ...
                <a href="{{url('/serviciospiura/empresaentel/tramites')}}"
