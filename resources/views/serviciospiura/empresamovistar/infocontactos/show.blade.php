        ...
        <div class="offset-lg-3 col-lg-6">
          ...
          <div class="card miBorder">
            ...
            <div class="card-block">
              ...
              {!!Form::open(['action'=>['Admininfo\infotelefonia\ContactosController@destroy',$empresa->id],'method'=>'DELETE'])!!}
            ...
            <div class="form-group">
              <strong>{!!form::label('Centro de atención:')!!}</strong>
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <a href="{{url('/serviciospiura/empresamovistar/contactos')}}" class="btn btn-secondary">Cancelar</a>
