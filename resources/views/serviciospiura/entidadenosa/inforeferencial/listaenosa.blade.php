...
<div class="breadcrumb-holder">
  ...
  <div class="container-fluid">
    ...
    @include('serviciospiura.mensajes.mensajes')
     <a href="{{url('serviciospiura/entidadenosa/reclamos')}}" class="btn btn-danger btn-sm margenInf fadeIn animated ion-plus-round"> Información de reclamos</a> &nbsp;
     <a href="{{url('serviciospiura/entidadenosa/tramites')}}" class="btn btn-warning btn-sm margenInf fadeIn animated ion-plus-round"> Información de tramites</a> &nbsp;    
     <a href="{{url('/serviciospiura/entidadenosa/contactos')}}" class="btn btn-success btn-sm margenInf fadeIn animated ion-plus-round"> Lista de contactos</a> &nbsp;          
  <div class="row"> 
    <div class="col-lg-12">
          ...
          <tr class="bg-primary">
              ...
              <th>Acciones</th>
                ...
                <tr class="fadeIn animated">
                  ...
                  <td> <a href="https://www.distriluz.com.pe/enosa/" target="_blank" title="Open Web">{{$empresa->webentidad}}</a></td>
