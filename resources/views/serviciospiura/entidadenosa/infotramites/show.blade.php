...
<div class="breadcrumb-holder">
    <div class="container-fluid">
      <ul class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{url('/entidadenosa/tramites/listar')}}">Entidad</a></li>
        ...
        <div class="offset-lg-3 col-lg-6">
          ...
          <div class="card miBorder">
            ...
            <div class="card-block">
              ...
              {!!Form::open(['action'=>['Admininfo\infoenosa\TramitesController@destroy',$tramites->id],'method'=>'DELETE'])!!}
              ...
              <div class="form-group">
                <a href="{{url('/serviciospiura/entidadenosa/tramites')}}" class="btn btn-secondary">Cancelar</a>
