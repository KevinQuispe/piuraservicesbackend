              ...
              <th>Acciones</th>
                ...
                <tr class="fadeIn animated">
                  ...
                  <td class="text-center">
                    <a href="{{action('Admininfo\infoenosa\TramitesController@edit', $tramites->id)}}" class="btn btn-outline-primary btn-sm ion-edit" title="Editar">Editar</a>
                    <a href=" {{action('Admininfo\infoenosa\TramitesController@show', $tramites->id)}}" class="btn btn-outline-danger btn-sm ion-android-delete" title="Eliminar">Eliminar</a>
                  </td>
                </tr>
              @endforeach
                </tbody>
