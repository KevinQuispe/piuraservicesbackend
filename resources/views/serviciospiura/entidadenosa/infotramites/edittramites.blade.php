...
<div class="breadcrumb-holder">
    <div class="container-fluid">
      <ul class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{url('/serviciospiura/enosa/tramites')}}">Usuarios</a></li>
        ...
        <div class="offset-lg-2 col-lg-7">
          <div class="card miBorder">
            ...
            <div class="card-block">
              {!!Form::model($tramites, ['action'=>['Admininfo\infoenosa\TramitesController@update',$tramites->id],'method'=>'PUT'])!!}
            ...
            <div class="form-group">
              ...
              {!!form::submit('Guardar',['name'=>'grabar','id'=>'grabar','content'=>'<span class="glyphicon glyphicon-floppy-disk">Guardar</span>',
                ...
                <a href="{{url('/serviciospiura/entidadenosa/tramites')}}" class="btn btn-primary ion-android-cancel btn-sm"> Cancelar</a>
              </div>
