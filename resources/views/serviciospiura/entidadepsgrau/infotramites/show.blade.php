...
<div class="breadcrumb-holder">
    <div class="container-fluid">
      <ul class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{url('/serviciospiura/entidadepsgrau/tramites')}}">Entidad</a></li>
        ...
        <div class="offset-lg-3 col-lg-6">
          ...
          <div class="card miBorder">
            ...
            <div class="card-block">
              <p>¿Desea eliminar datos del tramite?</p>
              {!!Form::open(['action'=>['Admininfo\infoepsgrau\TramitesController@destroy',$tramites->id],'method'=>'DELETE'])!!}
