...
<div class="breadcrumb-holder">
  ...
  <div class="container-fluid">
    ...
    <!-- rutas -->
     ...
     <a href="{{url('/serviciospiura/entidadepsgrau/tramites')}}" class="btn btn-warning btn-sm margenInf fadeIn animated ion-plus-round"> Información de tramites</a> &nbsp;    
     <a href="{{url('/serviciospiura/entidadepsgrau/contactos')}}" class="btn btn-success btn-sm margenInf fadeIn animated ion-plus-round"> Lista de contactos</a> &nbsp;         
  <div class="row"> 
    <div class="col-lg-12">
