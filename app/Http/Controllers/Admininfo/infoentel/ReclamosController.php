...
class ReclamosController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('serviciospiura.empresaentel.inforeclamos.create',compact('empresaid'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->action('Admininfo\infoentel\ReclamosController@index');
    ...
    public function show($id)
    {
      //  $id_entidad=\DB::table('inforeclamos')->select('id')->first()->id; //get id de la empresa
       ...
       $empresa = InfoReclamos::FindOrFail($id);
         return view('serviciospiura.empresaentel.inforeclamos.show',compact('empresa','empresaid'));
    }
    ...
    public function edit($id)
    {
        ...
        return View('serviciospiura.empresaentel.inforeclamos.editreclamos',compact('reclamos','empresaid'));
    }
