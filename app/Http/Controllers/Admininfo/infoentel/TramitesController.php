...
class TramitesController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('serviciospiura.empresaentel.infotramites.create',compact('empresaid'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->action('Admininfo\infoentel\TramitesController@index');
    ...
    public function show($id)
    {
        ...
        $tramites = InfoTramites::FindOrFail($id);
         return view('serviciospiura.empresaentel.infotramites.show',compact('tramites','empresaid'));
    }
    ...
    public function edit($id)
    {
        $empresaid= EntidadEmpresa::where('id', '5')->pluck('nombre','id');
        $tramites = InfoTramites::FindOrFail($id);
        return View('serviciospiura.empresaentel.infotramites.edittramites',compact('tramites','empresaid'));
    }
