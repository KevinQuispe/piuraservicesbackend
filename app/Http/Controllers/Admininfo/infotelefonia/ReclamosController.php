...
class ReclamosController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('serviciospiura.empresamovistar.inforeclamos.create',compact('empresaid'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->action('Admininfo\infotelefonia\ReclamosController@index');
    ...
    public function show($id)
    {
      //  $id_entidad=\DB::table('inforeclamos')->select('id')->first()->id; //get id de la empresa
       ...
       $empresa = InfoReclamos::FindOrFail($id);
         return view('serviciospiura.empresamovistar.inforeclamos.show',compact('empresa','empresaid'));
    }
    ...
    public function edit($id)
    {
        ...
        return View('serviciospiura.empresamovistar.inforeclamos.editreclamos',compact('reclamos','empresaid'));
    }
