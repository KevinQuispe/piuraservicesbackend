...
class TramitesController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('serviciospiura.entidadenosa.infotramites.create',compact('empresaid'));
    }
    ...
    public function show($id)
    {
        ...
        $tramites = InfoTramites::FindOrFail($id);
         return view('serviciospiura.entidadenosa.infotramites.show',compact('tramites','empresaid'));
    }
    ...
    public function edit($id)
    {
        $empresaid= EntidadEmpresa::where('id', '2')->pluck('nombre','id'); 
        $tramites = InfoTramites::FindOrFail($id);
        return View('serviciospiura.entidadenosa.infotramites.edittramites',compact('tramites','empresaid'));
    }
