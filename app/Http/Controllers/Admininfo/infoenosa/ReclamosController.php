...
class ReclamosController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('serviciospiura.entidadenosa.inforeclamos.create',compact('empresaid'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->action('Admininfo\infoenosa\ReclamosController@index');
    ...
    $empresa = InfoReclamos::FindOrFail($id);
         return view('serviciospiura.entidadenosa.inforeclamos.show',compact('empresa','empresaid'));
    }
    ...
    public function edit($id)
    {
        ...
        return View('serviciospiura.entidadenosa.inforeclamos.editreclamos',compact('reclamos','empresaid'));
    }
