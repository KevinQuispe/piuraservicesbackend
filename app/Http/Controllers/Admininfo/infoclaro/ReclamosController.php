...
class ReclamosController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('serviciospiura.empresaclaro.inforeclamos.create',compact('empresaid'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->action('Admininfo\infoclaro\ReclamosController@index');
    ...
    public function show($id)
    {
      ...
      $empresa = InfoReclamos::FindOrFail($id);
        return view('serviciospiura.empresaclaro.inforeclamos.show',compact('empresa','empresaid'));
    }
    ...
    public function edit($id)
    {
        ...
        return View('serviciospiura.empresaclaro.inforeclamos.editreclamos',compact('reclamos','empresaid'));
